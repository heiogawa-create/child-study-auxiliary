...
「かん字の よみかた／かきかた」単元は、学年別漢字配当表の配当漢字を全て収録しています（1年80字・2年160字・3年200字・4年202字・5年193字・6年191字、合計1026字）。学年をひらくたびに、その学年の配当漢字からランダムに出題されます。4〜6年生は画数・音訓つきの配当表と1字ずつ照合し、公式の配当数と完全に一致することを確認済みです。

※ 1〜3年生は配当数が公式と一致していますが、個々の字種までは配当表と1件ずつ照合できていません。誤りに気づいた場合はお知らせください。
