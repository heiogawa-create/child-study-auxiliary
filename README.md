...
「かん字の よみかた／かきかた」単元は、学年別漢字配当表の配当漢字をほぼ全て収録しています（1年80字・2年160字・3年200字・4年約219字・5年176字・6年177字、合計約1012字）。学年をひらくたびに、その学年の配当漢字からランダムに出題されます。

※ このリストは公開情報をもとに作成したもので、外部サイトへの再アクセスで最終照合はできていません。学年境界の数文字については実際の配当学年と前後している可能性があります。誤りに気づいた場合はお知らせください。
