...
「かん字の よみかた／かきかた」単元は、学年別漢字配当表の配当漢字をほぼ全て収録しています（1年80字・2年160字・3年200字・4年201字・5年192字・6年188字、合計1021字）。学年をひらくたびに、その学年の配当漢字からランダムに出題されます。4・5年生は音訓表つきの配当表を照合して修正済みです。

※ 6年生の一部（1〜3年生も含め全体）は公開情報をもとに作成したもので、公式の音訓表と1件ずつ照合できていません。学年境界の数文字については実際の配当学年と前後している可能性があります。誤りに気づいた場合はお知らせください。
